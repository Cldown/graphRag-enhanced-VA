...
# test
fields = [
    ('Col2', {"uid":"8168a8","order":1,"data":[".299",".279",".259",".239",".219",".199",".159",".119",".079",".039"]}),
    ('Col1', {"uid":"30eee6","order":0,"data":["15","14","13","12","11","10","8","6","4","2"]}),
]

fid = 'xiemei:82'

all_field_features, parsed_fields = extract_single_field_features(fields, fid)
print(f'all_field_features: {all_field_features[0]}')
print(f'all_field_features: {all_field_features[1]}')
